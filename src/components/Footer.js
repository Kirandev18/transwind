...
import Image1 from '../images/background/bgnew.jpeg'
export default () => {
    ...
    return (
        ...
        <img
          ...
          alt=""
        />
        <div className="relative  text-gray-500 pt-10 px-4 py-5 max-w-screen-xl mx-auto">
            <div className="gap-6   justify-between md:flex">
                <div className="flex-1">
                    <div className="max-w-xs">
                    <img src={img} className="w-full" />
                        <p className="leading-relaxed text-white mt-2 text-[15px]">
                    <b> Head Offcie : </b><br/>  A -52 AlB, 2nd Man Road, Peenya industrial Area. Phase IV, Peenya Bangalore, Karnataka 560058. <br/>
<b>Phone : </b> 080-4954599 636432 | 766 <br/>
<b>Email : </b> info@transwindtech.com 
                        </p>
                    </div>
            ...
            <div className="mt-12  py-6 border-t  items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0 text-white">
                    &copy; 2022 Transwind All rights reserved.
                </div>
